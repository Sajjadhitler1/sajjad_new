...
if is_chat_msg(msg) or is_super_group(msg) then
	...
	if settings.lock_cmds then
		lock_cmds = settings.lock_cmds
	else
		lock_cmds = 'no'
	end
	if settings.lock_inline then
		lock_arabic = settings.lock_inline
	else
		lock_inline = 'no'
	end
   ...
   if msg.text:match("^[!/#][Aa][Nn][Tt][Ii][Ss][Pp][Aa][Mm][102030405060708900][010203040506708090]$") then
