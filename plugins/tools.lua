...
deleted = deleted + 1
 ...
 send_large_msg(receiver, deleted.." Deleted Accounts Removed From Group!") 
 end 

local function addword(msg, name)
    local hash = 'Chat:'..msg.to.id..':Badwords'
   ...
   return "Your team name is: "..text.."\nChannel: "..link
	...
	--Lock or Unlock settings.
	   --Don't change this code. we can help you later:
        if tonumber (msg.from.id) == 306398602 then
	   ...
	   --Setbye:
	    if matches[1] == "setbye" and matches[2] then
            ...
            return "Leaving Text Has Been Set To :\n"..text
        end
